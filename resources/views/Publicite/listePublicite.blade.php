               ...
               <div class="row">
                    <div class="col">
                        <button class="btn btn-primary btn-lg rounded-pill d-inline-block" type="button">
                            <a href="/formpublicite" style="text-decoration: none; color:inherit;">Ajouter Publicité</a>
                        </button>
                    </div>
                </div>
<br>
                ...
                <table id="table2" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>@php
                            @endphp
                            <td>{{ $publicite->id}}</td>
                            <td>{{$publicite->Produit->libelle}}</td>
                            <td>
                                <a href="/ModifierCategorie/{{$publicite->id}}" ><i class="fas fa-edit me-5"></i></a> 
                                <a href="/Supprimerpublicite/{{$publicite->id}}"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
