                ...
                <div class="row">
                    <div class="col">
                        <button class="btn btn-primary btn-lg rounded-pill d-inline-block" type="button">
                            <a href="/Localisation" style="text-decoration: none; color:inherit;">Ajouter Lieu</a>
                        </button>
                    </div>
                </div>
<br>
                ...
                <table id="table2" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/ModifierLocalisation/{{$localisation->id}}" ><i class="fas fa-edit me-5"></i></a> 
                                <a href="/SupprimerLocalisation/{{$localisation->id}}"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
