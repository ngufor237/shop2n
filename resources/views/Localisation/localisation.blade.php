...
<body>
    ...
    <div class="row">
        ...
        <div class="container mt-5 col-md-4">
            <div class="card p-4">
                <h2 class="text-center mb-4">Nouvelle Localisation</h2>
                <hr>

                <form action="{{ route('AddLocalisation') }}" method="POST">
                    @csrf
                    @if(session('failcat'))
        ...
        {{ session('sucesscat') }}
                 ...
                 @endif  
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="localisation" placeholder="Entrer la ville-quartier">
                    </div>
                    <div class="row">
