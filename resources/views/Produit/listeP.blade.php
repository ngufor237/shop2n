                                ...
                                <tbody>
                                    @foreach ($produits as $produit)
                                        <tr style=' border:rgb(118, 118, 118) solid 1px; width:1000vh;'>
                                            ...
                                            <td style=' width: 25vh;'>
                                                Excellant:<?php echo number_format($produit->prix, 0, ',', ','); ?>FCFA <br>
                                                Bon etat:<?php echo number_format($produit->prixbonetat, 0, ',', ','); ?>FCFA <br>
                                                Correct:<?php echo number_format($produit->prixetatcorrect, 0, ',', ','); ?>FCFA </td>
                                            <td style='width: 25vh;'>
                                                Excellant :{{ $produit->qttestock }} <br>
                                                Bon etat:{{ $produit->qttestockbonetat }} <br>
                                                Correct :{{ $produit->qttestocketatcorrect }} </td>
                                            <td>
