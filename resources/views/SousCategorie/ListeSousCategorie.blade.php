               ...
               <div class="row">
                    <div class="col">
                        <button class="btn btn-primary btn-lg rounded-pill d-inline-block" type="button">
                            <a href="/SousCategorie" style="text-decoration: none; color:inherit;">Ajouter sous catégorie</a>
                        </button>
                    </div>
                </div>
<br>
        ...
        {{ session('statue') }}
                ...
                <table id="table2" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $category->id}}</td>
                            <td>{{ $category->Categorie->nomCat}}</td>
                            <td>{{ $category->nomsubCat}}</td>
                            <td>
                                <a href="/ModifierSousCategorie/{{$category->id}}" ><i class="fas fa-edit me-5"></i></a> 
                                <a href="/SupprimerSousCategorie/{{$category->id}}"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
