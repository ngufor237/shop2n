    ...
    <div class="row">
        ...
        <div class="container mt-5 col-md-8">
            <div class="card p-4">
                ...
                <form action="{{ route('Formachatsecre') }}" method="POST">
                    @csrf
                    @if(session('fail'))
                 ...
                 @endif  
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-3">
                            <label for="qtte" class="form-label"> Quantité</label>
                            <input type="number" class="form-control" id="qtte" name="qtte" placeholder="Entrer la quantite" required>
                        </div>
                        <div class="mb-3 col-md-3">
                            <label for="prix" class="form-label"> Prix Vente</label>
                            <input type="number" class="form-control" id="prix" name="prixv" placeholder="Entrer le prix de vente" required>
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" id="etat" name="etat" required>
                                ...
                                <option value="Bon">Très Bon État</option>
