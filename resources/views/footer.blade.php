            ...
            <div class="row px-xl-5 pt-1">
                <div class="col-lg-4 col-md-12 mb-0 pr-3 pr-xl-5">
                    <a href="" class="text-decoration-none">
                        <h3 class="mb-4 font-weight-semi-bold"><span class="text-primary font-weight-bold border border-white px-3 mr-1">E</span>2NCORPORATE</h3>
                    </a>
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="row">
                        <div class="col-md-4 mb-0">
                            <h5 class="font-weight-bold text-dark mb-0">Quick Links</h5>
