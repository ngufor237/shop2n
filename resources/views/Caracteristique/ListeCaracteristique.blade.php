                ...
                <div class="row">
                    <div class="col">
                        <button class="btn btn-primary btn-lg rounded-pill d-inline-block" type="button">
                            <a href="/Caracteristique" style="text-decoration: none; color:inherit;">Ajouter caracteristique</a>
                        </button>
                    </div>
                </div>
                <br>
                ...
                <table id="table2" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $caracteristique->nomCaract}}</td>
                            <td>
                                <a href="/ModifierCaracteristique/{{$caracteristique->id}}" ><i class="fas fa-edit me-5"></i></a> 
                                <a href="/SupprimerCaracteristique/{{$caracteristique->id}}"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
